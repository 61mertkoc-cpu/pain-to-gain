...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => GoalsPageWidget(),
        ),
        FFRoute(
          name: JourneyPageWidget.routeName,
          path: JourneyPageWidget.routePath,
          builder: (context, params) => JourneyPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: GoalEditorPageWidget.routeName,
          path: GoalEditorPageWidget.routePath,
          builder: (context, params) => GoalEditorPageWidget(
            goalRef: params.getParam(
              'goalRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['goals'],
            ),
            goalText: params.getParam(
              'goalText',
              ParamType.String,
            ),
          ),
...
class FFRoute {
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          // Always use a smooth fade+slide transition for a premium feel
          final effectiveTransitionType = transitionInfo.hasTransition
              ? transitionInfo.transitionType
              : PageTransitionType.fade;
          final effectiveDuration = transitionInfo.hasTransition
